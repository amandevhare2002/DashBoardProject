...
export const Layout = (props: PropsWithChildren) => {
  ...
  const pageBackground = useSelector((state: any) => state.authReducer.pageBackground);
  ...
  useEffect(() => {
    ...
    if (!headerList || headerList === 'null') {
      const Params = {
        ...
        PanelID: sessionStorage.getItem("panelID") ? sessionStorage.getItem("panelID") : 1,
      };
      axios
        .post(
        ...
        .then((response: any) => {
          sessionStorage.setItem("headerList", JSON.stringify(response.data.headersLists))
                    ...
                    <div className="app-main">
                      <div className="app-main__outer">
                        <div
                          ...
                          style={{
                            backgroundColor: pageBackground.color || 'default-color',
                            backgroundImage: pageBackground.image ? `url(${pageBackground.image})` : 'none',
